...
return [
    ...
    */
    'options' => [
        'delimiter' => '/',
        'fetch' => \Meow7\Phpimap\IMAP::FT_PEEK,
        'sequence' => \Meow7\Phpimap\IMAP::ST_UID,
        'fetch_body' => true,
        'fetch_flags' => true,
        'soft_fail' => false,
        'rfc822' => true,
    ...
    'events' => [
        "message" => [
            'new' => \Meow7\Phpimap\Events\MessageNewEvent::class,
            'moved' => \Meow7\Phpimap\Events\MessageMovedEvent::class,
            'copied' => \Meow7\Phpimap\Events\MessageCopiedEvent::class,
            'deleted' => \Meow7\Phpimap\Events\MessageDeletedEvent::class,
            'restored' => \Meow7\Phpimap\Events\MessageRestoredEvent::class,
        ],
        "folder" => [
            'new' => \Meow7\Phpimap\Events\FolderNewEvent::class,
            'moved' => \Meow7\Phpimap\Events\FolderMovedEvent::class,
            'deleted' => \Meow7\Phpimap\Events\FolderDeletedEvent::class,
        ],
        "flag" => [
            'new' => \Meow7\Phpimap\Events\FlagNewEvent::class,
            'deleted' => \Meow7\Phpimap\Events\FlagDeletedEvent::class,
        ],
    ],
     ...
     */
    'masks' => [
        'message' => \Meow7\Phpimap\Support\Masks\MessageMask::class,
        'attachment' => \Meow7\Phpimap\Support\Masks\AttachmentMask::class
    ]
];
